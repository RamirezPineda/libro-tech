  ...
  <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    <div class="mx-auto max-w-4xl">
      <header class="text-center">
        @if (!empty($laQrImage))
          <h2 class="text-gray-600 text-2xl font-medium">QR Generado</h2>
        @else
          <h2 class="text-gray-600 text-2xl font-medium">Carrito de Compras</h2>
        @endif
      </header>
      ...
      @if (!empty($laQrImage))
          <div class="mt-8">
            <div class="flex justify-center items-center">
              <img src="{{$laQrImage}}" alt="QR generado">
            </div>
          </div>
      @else
          ...
          <div class="w-screen max-w-lg space-y-4">
            ...
            <div class="flex justify-end" x-data="{ 'showModal': false }" @keydown.escape="showModal = false" x-cloak>
              ...
              <div style="background-color: rgba(0,0,0,0.5)" x-show="showModal" :class="{ 'fixed inset-0 z-10 flex items-center justify-center': showModal }">
                <!--Dialog-->
                <div class="bg-white w-full md:max-w-xl mx-auto rounded shadow-lg py-4 text-left px-6" x-show="showModal" @click.away="showModal = false" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 scale-90">
                  <div class="flex justify-between items-center pb-3">
                    <p class="text-2xl font-medium text-gray-700">PagoFacil</p>
                  ...
                  @if (Auth::user())
                    ...
                    <form id="ventaForm" method="POST" action="{{ route('venta.store') }}">
                      ...
                      <div class="flex flex-col mb-2">
                        <label for="nombre" class="text-gray-600">Nombre y Apellidos</label>
                      ...
                      <div class="flex justify-between items-center pt-2">
                        <div id="formLoading" class="flex justify-center items-center gap-2">
                          <p class="font-semibold text-gray-800">Generando QR</p>
