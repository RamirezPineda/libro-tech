      ...
      <div id="carrito-de-compras" class="mt-8">
        ...
        <div class="mt-8 flex justify-end border-t border-gray-100 pt-8">
          <div class="w-screen max-w-lg space-y-4">
            ...
            <div class="flex justify-end" x-data="{ 'showModal': false }" @keydown.escape="showModal = false" x-cloak>
              ...
              <div style="background-color: rgba(0,0,0,0.5)" x-show="showModal" :class="{ 'fixed inset-0 z-10 flex items-center justify-center': showModal }">
                <!--Dialog-->
                <div class="bg-white dark:bg-gray-800 w-full md:max-w-xl mx-auto rounded shadow-lg py-4 text-left px-6" x-show="showModal" @click.away="showModal = false" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 scale-90">
                  <div class="flex justify-between items-center pb-3">
                    <p class="text-2xl font-medium text-gray-700 dark:text-gray-300">PagoFacil</p>
                  ...
                  @if (Auth::user())
                    ...
                    <form id="ventaForm" method="POST" action="{{ route('venta.store') }}">
                      ...
                      <div class="flex flex-col mb-2">
                        <label for="nombre" class="text-gray-600 dark:text-gray-200">Nombre y Apellidos</label>
                        <input value="{{ Auth::user()->nombre }}" name="nombre" class="form-input outline-none w-full rounded-md" type="text" placeholder="Ricky Ramirez">
                      </div>
                      <div class="flex flex-col mb-2">
                        <label for="email" class="text-gray-600 dark:text-gray-200">Email</label>
                        <input value="{{ Auth::user()->email }}" name="email" class="form-input w-full rounded-md" type="email" placeholder="ramirez@gmail.com">
                      </div>
                      <div class="flex flex-col mb-2">
                        <label for="telefono" class="text-gray-600 dark:text-gray-200">Telefono</label>
                      ...
                      <div class="flex flex-col mb-2">
                        <label for="id_servicio" class="text-gray-600 dark:text-gray-200">Servicio Adicional (Bs)</label>
                      ...
                      <div class="flex flex-col mb-2">
                        <label for="tipoPago" class="text-gray-600 dark:text-gray-200">Tipo de pago</label>
                      ...
                      <div class="flex justify-between items-center pt-2">
                        <div id="formLoading" class="flex justify-center items-center gap-2">
                          <p class="font-semibold text-gray-800 dark:text-gray-200">Generando QR</p>
                          <img class="h-7 w-7 bg-cover" src="https://i.gifer.com/origin/34/34338d26023e5515f6cc8969aa027bca.gif" alt="loading">
                        </div>
                        <button
                          id="botonPagar"
                  ...
                  @else
                    <div class="gap-2 mt-4">
                      <h3 class=" font-semibold uppercase">Debe iniciar sesión para poder comprar</h3>
                      <br>
                      <a 
