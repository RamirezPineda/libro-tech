...
class RolSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'generos.index', 'description' => 'ver listado de generos'])->syncRoles([ $personal]);
        Permission::create(['name' => 'generos.create', 'description' => 'crear genero'])->syncRoles([$personal]);
        Permission::create(['name' => 'generos.edit', 'description' => 'editar genero'])->syncRoles([$personal]);
        Permission::create(['name' => 'generos.destroy', 'description' => 'eliminar genero'])->syncRoles([$personal]);
